...
class Blinky(Ghost):  # red ghost
    def __init__(self, sprites, square_size, map, player_rect, current_level):
        levels_settings = {1: {"move_time": 0.017, "move_speed": 2, "start_at_power_points": 0},
                           2: {"move_time": 0.016, "move_speed": 2, "start_at_power_points": 0},
                           3: {"move_time": 0.015, "move_speed": 2, "start_at_power_points": 0},
